...
export function WobbleCardDemo() {
  return (
    ...
    (<>
        <div className="text-3xl md:text-7xl font-bold dark:text-white text-center mb-2">Features</div>
    <div
      ...
      <WobbleCard
        ...
        <div className="max-w-xs">
          ...
          Chat, share ideas, and collaborate on topics that matter to you.
          Engage in group discussions, share insights, and learn from peers.
          </p>
        </div>
        <img
          src="/linear.webp"
      ...
      <WobbleCard containerClassName="col-span-1 min-h-[300px]">
        ...
        Get personalized interview practice and feedback to land your dream job.
        </p>
      </WobbleCard>
      <WobbleCard
        ...
        <div className="max-w-sm">
          <h2
            ...
            Daily Quizzes & Coding Reminders:
          </h2>
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
          Stay sharp with daily ai quizzes and get reminders for LeetCode challenges.
          </p>
        </div>
        <img
          src="/linear.webp"
